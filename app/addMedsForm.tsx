...
const AddMedsForm = () => {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: NAV_THEME.dark.background }]}>
      <Formik
          ...
          >
            ...
            <View style={styles.header}>
              <TouchableOpacity style={styles.backButton} onPress={goBack}>
                <MaterialIcons name="arrow-back-ios" size={20} color={NAV_THEME.dark.text} />
              </TouchableOpacity>
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity
                style={[styles.nextButton, { backgroundColor: NAV_THEME.dark.primary }]}
                onPress={async () => {
